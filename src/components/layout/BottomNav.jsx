        ...
        return (
          <button
            ...
            style={{
              ...
              color: isActive ? currentUser.color : T.textDim,
              background: isActive ? currentUser.colorSoft : 'transparent',
              border: `1px solid ${isActive ? currentUser.colorBorder : 'transparent'}`,
